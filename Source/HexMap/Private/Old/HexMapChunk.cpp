...
void AHexMapChunk::PostEditChangeProperty(struct FPropertyChangedEvent& Event)
{
	Super::PostEditChangeProperty(Event);
	FName PropertyName = (Event.Property != nullptr) ? Event.Property->GetFName() : NAME_None;
	if (PropertyName == GET_MEMBER_NAME_CHECKED(FRotator, Pitch) ||
		PropertyName == GET_MEMBER_NAME_CHECKED(FRotator, Yaw) || 
		PropertyName == GET_MEMBER_NAME_CHECKED(FRotator, Roll))
	{
